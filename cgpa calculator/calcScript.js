...
function calculateCGPA() {
    ...
    if (cgpa === 0) {
        document.getElementById('cgpaLabel').textContent = "No CGPA";
    } else {
        document.getElementById('cgpaLabel').textContent = "CGPA:";
    }

    document.getElementById('cgpa').textContent = cgpa; // Update CGPA value
}
